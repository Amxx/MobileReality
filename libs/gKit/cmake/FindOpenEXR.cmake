...
IF(OPENEXR_FOUND)
	SET(OPENEXR_LIBRARIES ${_openexr_LIBRARIES} CACHE PATH "OpenEXR components")
  # Both include paths are needed because of dummy OSL headers mixing #include <OpenEXR/foo.h> and #include <foo.h> :(
  SET(OPENEXR_INCLUDE_DIRS ${OPENEXR_INCLUDE_DIR} ${OPENEXR_INCLUDE_DIR}/OpenEXR CACHE PATH "OpenEXR includes")
ENDIF()
