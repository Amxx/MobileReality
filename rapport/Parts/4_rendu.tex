...
Un indice visuel primordial à la vraisemblance visuelle des images produites est la présence d’ombres portées provoquées par l’ajout de l’objet \todo{reference}.
